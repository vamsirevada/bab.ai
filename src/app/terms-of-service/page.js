        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-600 mb-6">
              Welcome to Bab.ai, your intelligent construction management
              platform. These Terms of Service (&quot;Terms&quot;) govern your
              use of the Bab.ai platform, services, and AI-powered insights. By
            ...
            <p className="text-gray-600 mb-6">
              By creating an account, accessing, or using any part of the Bab.ai
            ...
            <p className="text-gray-600 mb-4">Bab.ai provides:</p>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                credit facilities. Credit approval is subject to our
                partners&apos; terms and conditions, creditworthiness
              ...
              <p className="text-gray-600 mb-4">
                Our proprietary Trust Score is based on payment history,
                business details, and order behavior. This score influences
                credit limits and terms but does not guarantee approval.
              </p>
              ...
              <p className="text-gray-600 mb-4">
                ...
                charges, and fees as per the terms agreed with our financial
                partners. Bab.ai acts as a facilitator and is not liable for
                credit decisions or disputes.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                We maintain a network of verified vendors for construction
                materials and services. Verification includes business
                registration, past performance, and compliance checks, but does
                not guarantee quality or performance.
              </p>
              ...
              <p className="text-gray-600 mb-4">
                Bab.ai facilitates order placement and communication but is not
                a party to the actual transaction between you and vendors. All
                contracts, warranties, and liabilities are between you and the
                vendor.
              </p>
              ...
              <p className="text-gray-600 mb-4">
                Price estimates provided on our platform are indicative and
                subject to change. Final pricing, delivery terms, and
                specifications must be confirmed directly with vendors.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                and display such content for providing and improving our
                services.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                uninterrupted service. We may experience downtime for
              ...
              <p className="text-gray-600 mb-4">
                ...
                and make independent decisions regarding your construction
                projects.
              </p>
              ...
              <p className="text-gray-600 mb-4">
                Bab.ai is not responsible for the quality, performance, or
                actions of third-party vendors, financial institutions, or other
                service providers accessed through our platform.
              </p>
              ...
              <p className="text-gray-600 mb-4">
                To the maximum extent permitted by law, Bab.ai shall not be
            ...
            <p className="text-gray-600 mb-6">
              You agree to indemnify, defend, and hold harmless Bab.ai, its
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                support team. Termination does not relieve you of any
              ...
              <p className="text-gray-600 mb-4">
                ...
                violate these Terms, engage in prohibited activities, or pose a
                risk to our platform or other users.
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                accordance with the Arbitration and Conciliation Act, 2015.
              </p>
            </div>
            ...
            <p className="text-gray-600 mb-6">
              ...
              notifications. Continued use of our services after changes take
            ...
            <div className="text-gray-600 mb-6">
              ...
              <p>
                <strong>Phone:</strong> Available via platform support
              </p>
            </div>

            <div className="mt-8 p-4 bg-gray-50 rounded-lg">
              <p className="text-sm text-gray-600">
                <strong>Note:</strong> These terms are effective as of the last
                updated date shown above. Please review them periodically as
                they may change. Your continued use of Bab.ai constitutes
